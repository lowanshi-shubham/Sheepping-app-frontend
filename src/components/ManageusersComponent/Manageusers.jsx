...
function Manageusers() {
  ...
  const manageuserstatus=(_id,s)=>{
    if(s=="active")
    {
                const activconfirmation =confirm("are you sure to Active this user")
                if (activconfirmation) {
    ...
    {
                const deactivconfirmation =confirm("are you sure to De-active this user")
if (deactivconfirmation) {
    ...
    {
        const deletconfirmation =confirm("are you sure to delete user")
